...
public class ClientEntitySetIterator<T extends ClientEntitySet, E extends ClientEntity>
  ...
  private ResWrap<Entity> nextAtomEntityFromEntitySet(
    ...
    try {
      //Vimal - removed the closing > symbol in <entry>, because response from SP contains eTag attribute in entry tag 
      //like <entry etag=, so this code will never parse the response, hence fixed it to parse.

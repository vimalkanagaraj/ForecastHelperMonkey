...
abstract class AbstractAtomDealer {
  ...
  protected final QName innerErrorQName;
  ...
  public AbstractAtomDealer() {
	/* ** Edited by VIMAL to make the update REST API work in SP 2010** */
    namespaceMetadata = NS_METADATA;
    namespaceData = NS_DATASERVICES;
    ...
    innerErrorQName = new QName(namespaceMetadata, Constants.ERROR_INNERERROR);
    //errorTargetQName = new QName(namespaceMetadata, Constants.ERROR_TARGET);
  }
  ...
  protected void namespaces(final XMLStreamWriter writer) throws XMLStreamException {
    ...
    /* ** Edited by VIMAL to make the update REST API work in SP 2010** */
    writer.writeNamespace(Constants.PREFIX_METADATA, NS_METADATA);
    writer.writeNamespace(Constants.PREFIX_DATASERVICES, NS_DATASERVICES);
    /* ** Edited by VIMAL until here ** */
